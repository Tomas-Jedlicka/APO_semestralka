...
SOURCES = main.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c  knobs.c menu.c printWinner.c RGB.c array_functions.c player_functions.c
#SOURCES += font_prop14x16.c font_rom8x16.c
TARGET_EXE = change_me
TARGET_IP = 192.168.223.170
ifeq ($(TARGET_IP),)
